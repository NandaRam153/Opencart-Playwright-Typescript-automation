...
| [002](002-ci-wishlist-credentials.md) | CI fail-fast for wishlist E2E credentials | Accepted |
| [003](003-feature-scoped-api-services.md) | Feature-scoped HTTP services (`CatalogService`, `CartService`) | Accepted |
| [004](004-login-presentation-separation.md) | Generic login vs wishlist landing assertions | Accepted |

System context and diagrams: [../ARCHITECTURE.md](../ARCHITECTURE.md)
